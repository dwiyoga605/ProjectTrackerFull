(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('rxjs/Observable'), require('rxjs/add/observable/timer'), require('rxjs/add/operator/switchMap'), require('rxjs/add/operator/do'), require('rxjs/add/operator/takeWhile'), require('@angular/http'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', 'rxjs/Observable', 'rxjs/add/observable/timer', 'rxjs/add/operator/switchMap', 'rxjs/add/operator/do', 'rxjs/add/operator/takeWhile', '@angular/http', '@angular/common'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.ngxProgressbar = global.ng.ngxProgressbar || {}),global.ng.core,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.http,global.ng.common));
}(this, (function (exports,_angular_core,rxjs_Subject,rxjs_Observable,rxjs_add_observable_timer,rxjs_add_operator_switchMap,rxjs_add_operator_do,rxjs_add_operator_takeWhile,_angular_http,_angular_common) { 'use strict';
